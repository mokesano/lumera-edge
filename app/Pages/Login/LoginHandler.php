...
class LoginHandler extends CoreLoginHandler {
    ...
    /**
     * [WIZDAM HELPER] Find an existing or empty field/key for a Google email.
    ...
    public function googleUnlink($args, $request) {
        ...
        // Remove all Google email fields to prevent orphaned emails that may cause confusion or conflicts later.
        for ($i = 0; $i <= 4; $i++) {
